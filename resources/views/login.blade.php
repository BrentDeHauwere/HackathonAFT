...
<body>
	...
	<section class="main-content animated fadeInUpBig">
		<div id="login-register">
			...
			<input type="submit" class="submit-button login-button" value="Log in" for="form-login">
			<input type="submit" class="submit-button register-button" value="Register" for="form-register">
		</div>

		<div id="forgot-password">
			<section>
				<form action="" method="post" id="form-forgot-password">
					<input type="email" placeholder="e-mail" name="email" id="email-forgot-password"><br>
