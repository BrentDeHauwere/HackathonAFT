	...
	h19V251z" />
		...
		<section class="main-content animated fadeInUpBig">
			<div id="login-register">
				<article class="tabs">
					<section id="tab1">
						<form action="{{ url('/password/reset') }}" method="post" id="form-login">
							{!! csrf_field() !!}
				...
				<input type="submit" class="submit-button login-button" value="Log in" form="form-login" style="margin-top: 20px">
			</div>
		</section>
	</body>
</html>
